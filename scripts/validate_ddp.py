...
用 torchrun 启动：
    ...
    torchrun --nproc_per_node 1 scripts/validate_ddp.py --tokenizer models/tokenizer_v3 --bin dataset/pretrain_head.bin

    # 多卡：每进程独占一张卡，验证跨进程梯度同步
    torchrun --nproc_per_node 2 scripts/validate_ddp.py --tokenizer models/tokenizer_v3 --bin dataset/pretrain_head.bin
